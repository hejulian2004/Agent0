    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == 'hf':
            ...
            if self.config.rollout.rollout_type == 'multiturn':
                ...
                from verl.workers.rollout.vllm_rollout.vllm_evo_rollout_spmd import vLLMEvoTIRRollout
                ...
                from verl.workers.rollout.vllm_rollout.vllm_eval_genrm import EvalGenrmRollout
                ...
                raise NotImplementedError(f"rollout_type must be 'multiturn', 'evo', 'genrm', or 'agent0', got: {self.config.rollout.rollout_type}")
